(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  var ChatroomSearch = React.createClass({
      ...
      handleSearch: function handleSearch() {
          ...
          fetch('/chatroom/check', {
              ...
              if (data.exists) {
                  _this.props.onChatroomJoin(data.chatroomId, data.chatroomName);
              } else {
  ...
  var Main = React.createClass({
      ...
      handleLoginSuccess: function handleLoginSuccess(username) {
          this.setState({ curPage: 'ChatApp', username: username });
      },
  
      handleRouteRegister: function handleRouteRegister() {
      ...
      handleChatroomJoin: function handleChatroomJoin(chatroomId, chatroomName) {
          ...
          this.setState({ chatroomId: chatroomId, chatroomName: chatroomName, showSearch: false, showChatroom: true, chatroomKey: this.state.chatroomKey + 1 }, function () {
              socket.emit('join', { chatroomId: chatroomId, chatroomName: chatroomName, username: _this.state.username });
          });
      },
      ...
      render: function render() {
          return React.createElement(
              ...
              this.state.curPage !== 'Login' && this.state.curPage !== 'Register' && React.createElement(Sidebar, { onNavigate: this.handleNavigation }),
              this.state.curPage === 'ChatApp' && this.state.showSearch && React.createElement(ChatroomSearch, { onChatroomJoin: this.handleChatroomJoin }),
              this.state.curPage === 'ChatApp' && this.state.showChatroom && React.createElement(Chatroom, { key: this.state.chatroomKey, username: this.state.username, chatroomId: this.state.chatroomId, chatroomName: this.state.chatroomName }),
  ...
  var Message = React.createClass({
      ...
      render: function render() {
          var time = new Date(this.props.timestamp).toLocaleTimeString();
          console.log("Message props = "+JSON.stringify(this.props));
          var messageClassName = this.props.user === this.props.curUser ? 'my-message' : 'message';
          return React.createElement(
              'div',
  ...
  var MessageList = React.createClass({
      ...
      render: function render() {
          console.log("MessageList props = "+JSON.stringify(this.props));
          console.log("MessageList state = "+JSON.stringify(this.state));
  ...
  var MessageForm = React.createClass({
      ...
      handleSubmit: function handleSubmit(e) {
          ...
          socket.emit('send:message', { username :message.user, chatroomId: message.chatroomId, text: message.text });
          this.setState({ text: '' });
      },
  ...
  var Chatroom = React.createClass({
      ...
      _userChangedName: function _userChangedName(_ref) {
          ...
          messages = messages.map(function (msg) {
              return msg.username === oldName ? _extends({}, msg, { username: newName }) : msg;
          });
          this.setState({ messages: messages });
      },
      ...
      render: function render() {
          return React.createElement(
              ...
              React.createElement(MessageList, { messages: this.state.messages, user:this.props.username }),
  ...
  var Login = React.createClass({
      ...
      handleLoginClick: function handleLoginClick() {
          ...
          fetch('/login', {
              ...
              if (data.success) {
                  _this.props.onLoginSuccess(username); //로그인 성공시 -> onLoginSuccess 동작.
              } else {
                      alert('Login failed');
                  }
          });
      ...
      //회원가입 페이지로 이동
      handleRouteRegisterClick: function handleRouteRegisterClick() {
      ...
      render: function render() {
          return React.createElement(
              ...
              React.createElement(
                  'button',
                  { onClick: this.handleRouteRegisterClick },
                  '회원가입'
              )
          );
      }
      ...
      render: function render() {
          ...
          return React.createElement(
              ...
              React.createElement(
                  'button',
                  { onClick: function () {
                          return _this.handleNavigate('ChatroomSearch');
                      } },
                  '채팅방 검색'
              )
          );
